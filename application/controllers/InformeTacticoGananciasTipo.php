...
class InformeTacticoGananciasTipo extends CI_Controller {
    ...
    public function index()
    {
		...
		$tipos = $this->TipoCaso_model->obtener_lista_tipo_caso_juridico_3();
        ...
        $this->smarty->assign(array(
			...
			'nombre_pantalla' => 'Generar informe Táctico',
			'tipos' => $tipos
        ));
        $this->smarty->view('informe_tactico_01.php');
    }
	...
	public function post_informe()
	{
		...
		$id_tipo_caso_juridico = $this->input->post('id_tipo_caso_juridico');
		...
		if ($id_tipo_caso_juridico != '-1')
		{
			$lista_tipos = array($this->TipoCaso_model->obtener_datos_tipo_caso_juridico($id_tipo_caso_juridico));
		}
	...
	public function imprimir_informe()
	{
		...
		for ($i = 0; $i < count($resultados['tipos']); $i++)
		{
			$html .= "<tr>";
		...
		$data = array(
			'tabla' => $html,
			'nombre_informe' => 'Informe de ganancias de casos juridicos por tipo',
