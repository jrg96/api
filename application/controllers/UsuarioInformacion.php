...
class Usuarioinformacion extends CI_Controller {
    ...
    public function index($id_usuario)
    {
		...
		$total_records = $this->UsuarioSistema_model->obtener_total_registros_bitacora($id_usuario);
		...
		if ($total_records > 0){
			$params['resultados'] = $this->UsuarioSistema_model->obtener_lista_bitacora_acciones($limite_por_pagina, $inicio_indice, $id_usuario);
			
			// parametros para realizar la paginacion
			$config['base_url'] = base_url() . 'index.php/usuarioinformacion/index/' . $id_usuario;
        ...
        $this->smarty->assign(array(
			...
			'bitacora' => $params['resultados'],
			'pagina_actual' => $pagina_actual,
			'total_paginas' => $total_paginas,
			'links' => $params['links']
        ));
        $this->smarty->view('usuario_informacion.php');
    }
}