...
class Usuariolista extends CI_Controller {
    ...
    public function index()
    {
		...
		if ($total_records > 0){
			$params['resultados'] = $this->UsuarioSistema_model->obtener_lista_usuarios($limite_por_pagina, $inicio_indice);
			
			// parametros para realizar la paginacion
			$config['base_url'] = base_url() . 'index.php/usuariolista/index';
        ...
        $this->smarty->view('usuario_lista.php');
    }
}
