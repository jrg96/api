<?php
/* Smarty version 3.1.32, created on 2019-12-01 10:52:07
  from 'C:\xampp3\htdocs\api\application\views\templates\estrategico_panel.php' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5de3efb7f28549_18860956',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c5dd9f514bf55448ecb6b841e9318484dcae5b80' => 
    array (
      0 => 'C:\\xampp3\\htdocs\\api\\application\\views\\templates\\estrategico_panel.php',
      1 => 1575219122,
      2 => 'file',
    ),
  ),
...
function content_5de3efb7f28549_18860956 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
    ...
    <div class="container admin-panel">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-xl-6">
                <div class="card panel-item">
                    <div class="card-body center-text-align"><i class="fa fa-dollar panel-item-icon"></i>
                        <h4 class="card-title">Informes tácticos</h4>
                        <div class="row">
							<div class="col-xl-12">
			...
			<div class="col-md-6 col-lg-6 col-xl-6">
                <div class="card panel-item">
                    <div class="card-body center-text-align"><i class="fa fa-dollar panel-item-icon"></i>
                        <h4 class="card-title">Informes estratégicos</h4>
                        <div class="row">
							<div class="col-xl-12">
								<a href="/api/index.php/estrategico1/index" class="btn btn-primary btn-block btn-lg" style="margin-bottom:4px;white-space: normal;" type="button">Informe de ganancias de casos juridicos</a>
							</div>
                        </div>
                    </div>
                </div>
