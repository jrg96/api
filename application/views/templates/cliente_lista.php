                                    ...
                                    <tr>
                                        <td>
                                            <div class="btn-group" role="group">
												<a class="btn btn-success" role="button" href="/api/index.php/clientemodificar/index/{$usuario.id_datos_cliente}">
													<i class="fa fa-pencil"></i>
												</a>
												<a class="btn btn-primary" role="button" href="/api/index.php/clienteinformacion/index/{$usuario.id_datos_cliente}">
													<i class="fa fa-info"></i>
												</a>
												<a class="btn btn-danger" role="button" href="/api/index.php/clienteeliminar/index/{$usuario.id_datos_cliente}">
													<i class="fa fa-trash"></i>
												</a>
											</div>
                                        </td>
                                        <td>{$usuario.id_datos_cliente}</td>
